  ...
  <section id="hi-im-ellen" class="">
    <div class="hero">
      <div class="personal-image">
        ...
        <p style="margin-top: 12px; font-size: .9rem; max-width: 700px"><em>My dog, Gunner, is not nearly as excited about learning "high-five" as I am. <a href="https://www.instagram.com/elliembartling" target="_blank">Click here</a> for more photos of Gunner being not nearly as excited as I am about things.</em></p>
      </div>
      <div class="text">
        ...
        <p class="currently-nerding"><img width="40px" src="dist/images/noun_844674.png"><em>Currently nerding out about: <a href="https://www.amazon.com/Blank-Slate-Modern-Denial-Nature-ebook/dp/B000QCTNIM/ref=sr_1_1?ie=UTF8&qid=1500250928&sr=8-1&keywords=the+blank+slate">The Blank Slate</a></em></p>
      </div>
    </div>
    <div class="cool-thing thing-atfvr">
    ...
    <div class="why-both">
      ...
      <div class="stack">
        <h5 class="subtitle">Design Stack</h5>
        <ul class="stack-list">
          <li>Sketch</li>
          <li>Photoshop</li>
          <li>Framer.js</li>
        ...
        <h5 class="subtitle">Tech Stack</h5>
        <ul class="stack-list">
          <li><b>Javscript</b></li>
          <li>Node</li>
          <li>jQuery</li>
      ...
      <div class="stack">
        <h5 class="subtitle">College</h5>
        <ul class="stack-list">
          <li><a href="https://www.ccs.ucsb.edu/what-is-ccs" target="_blank">College of Creative Studies, UCSB</a></li>
          <li><em>B.A. in English Literature, B.A. in Evolutionary Biology</em></li>
          <p></p>
        </ul>
        <p></p>
        <h5 class="subtitle">C.V.</h5>
        <ul class="stack-list">
          <li><b>Communications Assistant @ Texas Public Policy Foundation</b></li>
          <!-- <li><em>Texas Public Policy Foundation</em></li> -->
          <p>I started my career at a non-profit, public policy organization where I designed graphics, documents & posters, crafted press releases, tracked media hits, wrote scripts, shot interviews, recorded podcasts, edited in Final Cut, and managed relationships with 8,000+ followers on social media. I also project-managed the internal side of an award-winning website redesign, and founded the in-house analytics program (to this day, the program is still colloquially called "Holodeck" &mdash; for which I proudly claim credit <img width="20px" src="dist/images/noun_54427.png"/>).</p>
          <li><b>UX + UI Designer @ Emergent Order</b></li>
